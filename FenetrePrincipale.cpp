...
void FenetrePrincipale::createGroup()
{
...
void FenetrePrincipale::Afficher()
{
...
void FenetrePrincipale::AjouterCSV()
{
    ...
    if(!lesDonnees.open(QIODevice::WriteOnly | QIODevice::Text | QIODevice::Append))
        return;
